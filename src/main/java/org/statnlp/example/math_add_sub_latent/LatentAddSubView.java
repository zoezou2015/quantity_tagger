...
public class LatentAddSubView extends VisualizationViewerEngine {
	...
	public LatentAddSubView(Map<Integer, Label> labels) {
		super(null);
		this.labels = labels;
	}

	public LatentAddSubView(InstanceParser instanceParser) {
