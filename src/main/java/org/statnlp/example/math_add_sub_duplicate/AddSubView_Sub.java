...
public class AddSubView_Sub extends VisualizationViewerEngine {
	...
	public AddSubView_Sub(Map<Integer, Label> labels) {
		super(null);
		this.labels = labels;
	}

	public AddSubView_Sub(InstanceParser instanceParser) {
