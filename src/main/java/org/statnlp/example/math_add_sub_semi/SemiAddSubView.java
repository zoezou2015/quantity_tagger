...
public class SemiAddSubView extends VisualizationViewerEngine {
	...
	public SemiAddSubView(Map<Integer, Label> labels) {
		super(null);
		this.labels = labels;
	}

	public SemiAddSubView(InstanceParser instanceParser) {
