...
public class FixAddSubView extends VisualizationViewerEngine {
	...
	public FixAddSubView(Map<Integer, Label> labels) {
		super(null);
		this.labels = labels;
	}

	public FixAddSubView(InstanceParser instanceParser) {
