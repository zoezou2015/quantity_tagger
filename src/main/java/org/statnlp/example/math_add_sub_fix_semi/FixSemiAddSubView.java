...
public class FixSemiAddSubView extends VisualizationViewerEngine {
	...
	public FixSemiAddSubView(Map<Integer, Label> labels) {
		super(null);
		this.labels = labels;
	}

	public FixSemiAddSubView(InstanceParser instanceParser) {
