...
public abstract class BaseInstance<SELF extends BaseInstance<SELF, IN, OUT>, IN, OUT> extends Instance {
	...
	public SELF duplicate() {
		SELF result = null;
		try {
			result = (SELF) this.getClass().getConstructor(int.class, double.class).newInstance(this.getInstanceId(),
					this.getWeight());
		} catch (InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException
				| NoSuchMethodException | SecurityException e) {
			throw new RuntimeException(
					"Instance cannot be automatically duplicated. Please override duplicate() function in Instance implementation.");
		}
	 ...
	 * Note that generally it is expected that the returned object is not the same
	 * object
	 * 
	 * @return
	 */
	...
	public IN duplicateInput() {
		try {
			return this.input == null ? null
					: (IN) GeneralUtils.getMatchingAvailableConstructor(this.input.getClass(), this.input.getClass())
	...
	public OUT duplicateOutput() {
		try {
			return this.output == null ? null
					: (OUT) GeneralUtils.getMatchingAvailableConstructor(this.output.getClass(), this.output.getClass())
							.newInstance(this.output);
		} catch (InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException
				| NoSuchMethodException | SecurityException e) {
			throw new RuntimeException(
					"Cannot duplicate output automatically, please override duplicateOutput method.");
		}
	}
	...
	public OUT duplicatePrediction() {
		try {
			return this.prediction == null ? null
					: (OUT) GeneralUtils
							.getMatchingAvailableConstructor(this.prediction.getClass(), this.prediction.getClass())
							.newInstance(this.prediction);
		} catch (InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException
				| NoSuchMethodException | SecurityException e) {
			throw new RuntimeException(
					"Cannot duplicate prediction automatically, please override duplicatePrediction method.");
		}
	}
	...
	public List<OUT> duplicateTopKPredictions() {
		try {
			return this._topKPredictions == null ? null
					: (List<OUT>) GeneralUtils.getMatchingAvailableConstructor(this._topKPredictions.getClass(),
							this._topKPredictions.getClass()).newInstance(this._topKPredictions);
		} catch (InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException
				| NoSuchMethodException | SecurityException e) {
			throw new RuntimeException(
					"Cannot duplicate prediction automatically, please override duplicatePrediction method.");
